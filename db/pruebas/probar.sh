...
INSERT INTO tenants (nombre, codigo, whatsapp) VALUES ('Chamos C', 'chamos-c', '573001112233'), ('Chamos D', 'chamos-d', '573001112244');  -- sin usuarios: los usan las pruebas del catálogo (C) y del turno (D)
DO $$
DECLARE t record;
BEGIN
